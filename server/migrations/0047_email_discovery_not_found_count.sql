-- 0047_email_discovery_not_found_count.sql
-- Expose emailDiscovery.notFound from get_job_stage_counts so the UI can show
-- attempted finds (found + notFound) and a real hit rate instead of always 100%.
