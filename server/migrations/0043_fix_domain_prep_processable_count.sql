-- 0043_fix_domain_prep_processable_count.sql
-- Domain-prep processable must reflect DNS input cohort, not post-waterfall
-- job_domains.status (unmatched domains become skipped later).
