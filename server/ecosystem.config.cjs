...
const baseEnv = {
  ...
  ...(envOrUnset('RESEND_API_KEY') ? { RESEND_API_KEY: process.env.RESEND_API_KEY } : {}),
  ...(envOrUnset('RESEND_WEBHOOK_SECRET') ? { RESEND_WEBHOOK_SECRET: process.env.RESEND_WEBHOOK_SECRET } : {}),
